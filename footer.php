  ...
  <section class="cta"><div class="wrap cta-inner"><div><p class="eyebrow">Free mold inspection</p><h2>Not sure what you are dealing with?</h2><p>Call our proudly Canadian team or submit the short form to request your free inspection.</p></div><a class="button phone-button" href="tel:+16048003900"><span>Speak with us</span>(604)800-3900</a></div></section>
  ...
  document.querySelectorAll('.lead-form').forEach(function(form){
    form.addEventListener('submit',function(event){
      ...
      grecaptcha.ready(function(){grecaptcha.execute(key,{action:'lead_form'}).then(function(token){form.querySelector('[name="recaptcha_token"]').value=token;form.dataset.verified='1';form.submit();}).catch(function(){button.disabled=false;button.textContent='Request free inspection →';});});
    });
  });
